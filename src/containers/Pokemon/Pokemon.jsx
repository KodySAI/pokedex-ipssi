                ...
                <div className="flex flex-wrap mx-4 justify-start w-80">
                  {types
                    ? types.map((item) => {
                        ...
                        return (
                          <div
                            className={`p-2 w-28 mr-2 rounded-full border-4 border-gray-200 text-white capitalize font-bold text-center ${item.type.name} cursor-pointer`}
                            key={item.type.name}
                            onClick={() => redirect(item.type.name)}
                          >
                            {item.type.name}
                          </div>
                        );
                ...
                {evolves_from_species ? (
                  <div className="flex justify-center capitalize">
                    <div className="bg-white w-32 rounded">
                      <Link
                        to={`/pokemon/${evolves_from_species.name}`}
                        replace
                      >
